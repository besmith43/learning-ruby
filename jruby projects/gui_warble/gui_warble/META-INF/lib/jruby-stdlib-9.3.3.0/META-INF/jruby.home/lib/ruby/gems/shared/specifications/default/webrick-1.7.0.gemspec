...
Gem::Specification.new do |s|
  ...
  s.files = ["Gemfile".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "bin/console".freeze, "bin/setup".freeze, "lib/webrick.rb".freeze, "lib/webrick/accesslog.rb".freeze, "lib/webrick/cgi.rb".freeze, "lib/webrick/compat.rb".freeze, "lib/webrick/config.rb".freeze, "lib/webrick/cookie.rb".freeze, "lib/webrick/htmlutils.rb".freeze, "lib/webrick/httpauth.rb".freeze, "lib/webrick/httpauth/authenticator.rb".freeze, "lib/webrick/httpauth/basicauth.rb".freeze, "lib/webrick/httpauth/digestauth.rb".freeze, "lib/webrick/httpauth/htdigest.rb".freeze, "lib/webrick/httpauth/htgroup.rb".freeze, "lib/webrick/httpauth/htpasswd.rb".freeze, "lib/webrick/httpauth/userdb.rb".freeze, "lib/webrick/httpproxy.rb".freeze, "lib/webrick/httprequest.rb".freeze, "lib/webrick/httpresponse.rb".freeze, "lib/webrick/https.rb".freeze, "lib/webrick/httpserver.rb".freeze, "lib/webrick/httpservlet.rb".freeze, "lib/webrick/httpservlet/abstract.rb".freeze, "lib/webrick/httpservlet/cgi_runner.rb".freeze, "lib/webrick/httpservlet/cgihandler.rb".freeze, "lib/webrick/httpservlet/erbhandler.rb".freeze, "lib/webrick/httpservlet/filehandler.rb".freeze, "lib/webrick/httpservlet/prochandler.rb".freeze, "lib/webrick/httpstatus.rb".freeze, "lib/webrick/httputils.rb".freeze, "lib/webrick/httpversion.rb".freeze, "lib/webrick/log.rb".freeze, "lib/webrick/server.rb".freeze, "lib/webrick/ssl.rb".freeze, "lib/webrick/utils.rb".freeze, "lib/webrick/version.rb".freeze, "webrick.gemspec".freeze]
