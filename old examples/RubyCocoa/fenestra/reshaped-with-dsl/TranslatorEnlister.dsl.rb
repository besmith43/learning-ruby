...
class TranslatorEnlister < OSX::NSObject
  ...
  def init
    ...
    connect_all_notification_observers    # (2)
  ...
  on_local_notification AppChosen do | notification |    # (3)
    display_choice = notification[:app_name].to_ruby     # (4) 
