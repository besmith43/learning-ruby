...
module PrefsWindowTests
  class RubyFileChooserControllerTest < Test::Unit::TestCase
    ...
    context "in action" do
      ...
      should "respond to NeedsRubySource notifications by starting chooser" do
        during { 
      ...
      should "restrict chooseable files to ruby files" do
        during { 
          some_object_announces(NeedsRubySource)
        }.behold! {
          @chooser_panel.should_receive(:runModalForTypes, 1).once.
      ...
      should "do nothing if panel cancels" do
        during { 
          some_object_announces(NeedsRubySource)
        }.behold! {
          @chooser_panel.should_receive(:runModalForTypes, 1).once.
      ...
      context "when file is chosen," do
        should "announce HasRubySource with source and row" do
          during { 
