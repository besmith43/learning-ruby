...
module PrefsWindowTests
  class PrefsControllerRemoveActionTest < Test::Unit::TestCase
    ...
    context "removing a row" do
      ...
      # 0 1 _2_ 3 4   => 
      # 0 1 _3_ 4
      should_eventually "select the next row, if there is one" do
        make_row_selection(2)
      ...
      # 0 _1_ _2_ 3 4 => 
      # 0 _3_  4
      should_eventually "even select the next row if given a selected range" do
      ...
      # _0_ _1_ 2 _3_ 4 =>
      #  2  _4_
      should_eventually "even select next row if given a disjoint set" do
      ...
      # 0 1 2  3 _4_ => 
      # 0 1 2 _3_ 
      should_eventually "select the last table row, if there is no next row" do
      ...
      # 0 1  2 _3_ _4_ => 
      # 0 1 _2_ 
      should_eventually "even select the last row if given a contiguous range" do
      ...
      # 0 1  _2_ 3 _4_ => 
      # 0 1 _3_ 
      should_eventually "even select the last row in a disjoint range" do
      ...
      # _0_ _1_ _2_ _3_ _4_ =>
      # 
      should_eventually "select nothing if the table is now empty" do
