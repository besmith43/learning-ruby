...
module RubyCocoaLocations
  ...
  # PORT: Right now, RubyGems doesn't load the Linguistics
  # gem. MacRuby comes with a new major version of RubyGems, so I
  # probably just need to learn the trick. But it's not been easy.
  ...
  def self.load_ruby_files
    ...
    rbfiles.each { |file| $stderr.puts file; require(file) }
  end
