...
class TranslatorPreference
  ...
  def favorite    # PORT: Fix this - should no longer be needed.
    return true if @favorite == true
    return false if @favorite == false
    @favorite
  end
  ...
  def encodeWithCoder(coder)
    Properties.each do | prop |
      ...
      coder.encodeObject value, forKey: prop
    end
